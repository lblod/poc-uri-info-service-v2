defmodule Dispatcher do
  ...
  # API SERVICES
  ###############
  match "/model/*path", %{ layer: :api_services, accept: %{ json: true } } do
    forward conn, path, "http://uri-info-service-v2/model"
  end
  match "/meta/*path", %{ layer: :api_services, accept: %{ json: true } } do
    forward conn, path, "http://uri-info-service-v2/meta"
  end
  match "/page/*path", %{ layer: :api_services, accept: %{ json: true } } do
